...
const file_raft_proto_raft_proto_rawDesc = "" +
	"\n" +
	"\x15raft/proto/raft.proto\x12\x04raft\x1a\x1cgoogle/api/annotations.proto\"H\n" +
	"\x13ForwardApplyRequest\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\x12\x1d\n" +
	"\n" +
	"timeout_ms\x18\x02 \x01(\x03R\ttimeoutMs\"0\n" +
	"\x14ForwardApplyResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\"o\n" +
	"\x0eAddPeerRequest\x12\x17\n" +
	"\apeer_id\x18\x01 \x01(\tR\x06peerId\x12!\n" +
	"\fpeer_address\x18\x02 \x01(\tR\vpeerAddress\x12!\n" +
	...
	"\x13GetPeerInfoResponse\x12\x16\n" +
	"\x06exists\x18\x01 \x01(\bR\x06exists\x12!\n" +
	"\fgrpc_address\x18\x02 \x01(\tR\vgrpcAddress2\xf3\x02\n" +
	"\vRaftService\x12h\n" +
	"\fForwardApply\x12\x19.raft.ForwardApplyRequest\x1a\x1a.raft.ForwardApplyResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v1/raft/forward-apply\x12T\n" +
	"\aAddPeer\x12\x14.raft.AddPeerRequest\x1a\x15.raft.AddPeerResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11/v1/raft/add-peer\x12`\n" +
	"\n" +
	"RemovePeer\x12\x17.raft.RemovePeerRequest\x1a\x18.raft.RemovePeerResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/v1/raft/remove-peer\x12B\n" +
	"\vGetPeerInfo\x12\x18.raft.GetPeerInfoRequest\x1a\x19.raft.GetPeerInfoResponseB,Z*github.com/gatewayd-io/gatewayd/raft/protob\x06proto3"
