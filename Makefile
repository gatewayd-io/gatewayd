...
build-release: tidy
	...
	@GOOS=linux GOARCH=amd64 go build -trimpath -ldflags "-s -w ${EXTRA_LDFLAGS}" -o dist/linux-amd64/gatewayd
	...
	@GOOS=linux GOARCH=arm64 go build -trimpath -ldflags "-s -w ${EXTRA_LDFLAGS}" -o dist/linux-arm64/gatewayd
	...
	@GOOS=darwin GOARCH=amd64 go build -trimpath -ldflags "-s -w ${EXTRA_LDFLAGS}" -o dist/darwin-amd64/gatewayd
	...
	@GOOS=darwin GOARCH=arm64 go build -trimpath -ldflags "-s -w ${EXTRA_LDFLAGS}" -o dist/darwin-arm64/gatewayd
